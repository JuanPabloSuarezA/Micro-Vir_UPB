...
import {LockOutlined, SmileOutlined, UserOutlined, UserAddOutlined} from "@ant-design/icons";
    ...
    render() {
        ...
        const registerApi = async () => {
            if (this.state.password === this.state.confirmPassword){
                ...
                try {
                    const {data} = await axios.post("http://localhost:4000/auth/register", params, config);
                    ...
                    notification.open({
                        ...
                        message: 'Error',
                        description: 'Puede que el usuario ya exista o que el formato del email sea incorrecto. ' +
            ...
            <div>
                ...
                >
                    <Form.Item
                        ...
                        <Input name="userName" prefix={<SmileOutlined className="site-form-item-icon" />} 
